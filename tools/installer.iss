#define AppName       "GTACOMPTA"
#define AppSourceDir  "..\build\GTACOMPTA\"
#define AppExeName    "GTACOMPTA.exe"
#define                MajorVersion    
#define                MinorVersion    
...
#define AppURL        "https://github.com/Odizinne/GTACOMPTA"
#define AppIcon       "..\Resources\icons\icon.ico"
#define CurrentYear   GetDateTimeString('yyyy','','')

[Setup]
AppId={{2fe7b59f-aa0b-43e7-a464-dc090388037f}}
AppName={#AppName}
...
OutputBaseFilename=GTACOMPTA_installer
Compression=lzma
